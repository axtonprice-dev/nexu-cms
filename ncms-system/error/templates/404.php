...
<body>
    <div class="container">
        <div class="error">
            <h1>404</h1>
            <h2>error</h2>
            <p>This page either doesn't exist, or it moved somewhere else. If you think this is an error, please <a href="https://discord.gg/dP3MuBATGc">let us know</a> so we can fix it!</p>
        </div>
